		...
		<table class='table text-tbody table-header-bordered'>
			...
			<tbody>
				...
				foreach($ap_entries->result() as $key){
					echo "<tr>";
					echo "	<td class='padding-left-10 one-fourth text-left table-td-outline-left '>".$key->ap_trans_account_code."</td>";
					echo "	<td class='padding-left-10 one-half text-left table-td-outline-left '>".$key->ap_trans_sub_name."</td>";
					echo "	<td class='padding-left-10 table-td-outline-left text-right padding-right-5'>".$key->ap_trans_dr."</td>";
					echo "	<td class='padding-left-10 table-td-outline-left text-right table-td-outline-right padding-right-5'>".$key->ap_trans_cr."</td>";
					echo "</tr>";
				}
				?>
				<!-- Showing of TOTAL -->
