		...
		<table class='table text-tbody table-header-bordered'>
			...
			<tbody>
				...
				foreach($cr_entries->result() as $key){
					echo "<tr>";
					echo "	<td class='padding-left-10 one-fourth text-left table-td-outline-left '>".$key->cr_trans_account_code."</td>";
					echo "	<td class='padding-left-10 one-half text-left table-td-outline-left '>".$key->cr_trans_sub_name."</td>";
					echo "	<td class='padding-left-10 table-td-outline-left text-right padding-right-5'>".$key->cr_trans_dr."</td>";
					echo "	<td class='padding-left-10 table-td-outline-left text-right table-td-outline-right padding-right-5'>".$key->cr_trans_cr."</td>";
					echo "</tr>";
				}
				?>
				<!-- Showing of TOTAL -->
