			...
			<ul>
				...
				<li role="tab" id="tab-journal" class="tab-link <?=($page_tab=='Journal') ? 'active' : '' ?>" >
					...
					<ul class="ul-link collapse animate-10 <?=($page_tab=='Journal') ? 'in': ''?>" id="journal">
						<li class="menu-link" id="accounts_payable" data-tab="tab-journal" data-ul="journal" data-menu="accounts_payable" data-address="accounts_payable"><a href="javascript:;">Accounts Payable</a></li>
				...
				<li class="tab-link <?=($page_tab=='Set Up') ? 'active' : '' ?>" role="tab" id="tab-setup">
					...
					<ul class="ul-link collapse animate-10 <?=($page_tab=='Set Up') ? 'in': ''?>" id="setup">
						<li class="<?=($page_title=='Main Account') ? 'active': ''?> menu-link" id="main-account" data-tab="tab-setup" data-ul="setup" data-menu="main-account" data-address="main_account"><a href="javascript:;">Main Account</a></li>
